...
\(\Pisurr \approx b^2/(4T\delta)\) holds within a factor of about two in
healthy states and fails, as expected, when the boundary region degenerates
(factor 10 during late inflation; factor \(10^{4}\) post-collapse).
...
exact \(\Pisurr\) against the dense-boundary approximation.}
\end{figure}
