...
the earliest healthy worst-block value (step 2000 for the 20k-horizon
runs, step 1000 for the 10k-horizon runs --- thousands of steps before the
earliest observed collapse). 
