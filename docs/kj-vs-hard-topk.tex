...
light to dark with increasing $J$). Left panel $T=2$, right panel post-norm.
The vertical axis is capped at 2.0 nats throughout: no run in this campaign
diverged, so nothing happens above that line after the first few thousand
steps.
