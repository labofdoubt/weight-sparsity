...
\includegraphics[width=.94\textwidth]{figures/mdinit_val_soft.png}
\caption{Validation CE for the basic LapSum family. Color encodes the
$(K,J,T)$ configuration; line style encodes the regime (full MD solid,
...
\begin{figure}[h]\centering
\includegraphics[width=.94\textwidth]{figures/mdinit_val_rblapsum_kappa.png}
\caption{Validation CE for the RBLapSum \code{through\_rank\_kappa} family.
Encoding as in the previous figure; an open circle marks the last available
point of a run still training at the time of this snapshot.}
\end{figure}
...
\caption{Validation CE for the hard AbsTopK family (no surrogate gradient).
Encoding as in the previous figures. No run in this family diverged.}
\end{figure}
